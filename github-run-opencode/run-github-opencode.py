...
def main() -> int:
    ...
    if reasoning_effort or enable_thinking == "true":
        options: dict = {}
        if reasoning_effort:
        ...
        patch: dict = {"agent": {"build": {"options": options}}}

        target_dir = get_env("OPENCODE_WORKING_DIRECTORY") or "."
        config_file = Path(target_dir) / "opencode.json"
        ...
        if config_file.exists():
            ...
            config_file.write_text(json.dumps(patch, indent=2) + "\n", encoding="utf-8")
